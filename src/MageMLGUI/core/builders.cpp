...
#include <MageMLGUI/core/builders.h>
...
void util::BlueprintNodeBuilder::Input(ed::PinId id)
{
    ...
    NodeLayout::BeginHorizontal(id.AsPointer());
}

void util::BlueprintNodeBuilder::EndInput()
{
    NodeLayout::EndHorizontal();
...
bool util::BlueprintNodeBuilder::SetStage(Stage stage)
{
    ...
    switch (oldStage)
    {
        ...
        case Stage::Header:
            ...
            NodeLayout::Spring(0, ImGui::GetStyle().ItemSpacing.y * 2.0f);
        ...
        case Stage::Input:
           ...
           NodeLayout::Spring(1, 0);
            NodeLayout::EndVertical();
    ...
    {
        case Stage::Begin:
            NodeLayout::BeginVertical("node");
            break;

        case Stage::Header:
            HasHeader = true;

            NodeLayout::BeginHorizontal("header");
            break;
        ...
        case Stage::Content:
            ...
            NodeLayout::BeginHorizontal("content");
           NodeLayout::Spring(0, 0);
            break;

        case Stage::Input:
            NodeLayout::BeginVertical("inputs", ImVec2(0, 0), 0.0f);
        ...
        case Stage::Middle:
           NodeLayout::Spring(1);
            NodeLayout::BeginVertical("middle", ImVec2(0, 0), 1.0f);
            break;
        ...
        case Stage::Output:
            if (oldStage == Stage::Middle || oldStage == Stage::Input)
               ...
               NodeLayout::Spring(1, 0);
            NodeLayout::BeginVertical("outputs", ImVec2(0, 0), 1.0f);
