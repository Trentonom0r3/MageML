...
#include "error/CxException.hpp" // Custom exception class for FFmpeg errors
#define LOG_TENSOR_INFO(tensor)                                                        \
    std::cerr << "[TENSOR] device: " << tensor.device() << "\n";                       \
    std::cerr << "[TENSOR] sizes: " << tensor.sizes() << "\n";                         \
    std::cerr << "[TENSOR] strides: " << tensor.strides() << "\n";                     \
    std::cerr << "[TENSOR] dtype: " << tensor.dtype() << "\n";                         \
    std::cerr << "[TENSOR] defined: " << tensor.defined() << "\n";
