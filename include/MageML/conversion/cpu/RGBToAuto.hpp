...
#include "MageML/conversion/cpu/CPUConverter.hpp"
#include <iostream>
#include <stdexcept>
...
class RGBToAutoConverter : public ConverterBase
{
  public:
     ...
     *
     * @param frame  Output MageML::Frame (must be pre-allocated, correct format/size).
     * @param buffer Input buffer (raw RGB24, typically from tensor).
     */
    void convert(MageML::Frame& frame, void* buffer) override
    {
