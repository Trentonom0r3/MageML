...
#include "MageML/backends/Decoder.hpp" // Ensure this includes the Filter class
#include "MageML/Factory.hpp"
...
class GUIReader
{
  public:
    ...
    // Member variables
    std::shared_ptr<MageML::Decoder> decoder;
    MageML::Decoder::VideoProperties properties;
